...
consvar_t cv_soundvolume = CVAR_INIT ("soundvolume", "18", CV_SAVE | CV_SLIDER_SAFE, soundvolume_cons_t, NULL);
consvar_t cv_digmusicvolume = CVAR_INIT ("digmusicvolume", "18", CV_SAVE | CV_SLIDER_SAFE, soundvolume_cons_t, NULL);
consvar_t cv_midimusicvolume = CVAR_INIT ("midimusicvolume", "18", CV_SAVE | CV_SLIDER_SAFE, soundvolume_cons_t, NULL);
